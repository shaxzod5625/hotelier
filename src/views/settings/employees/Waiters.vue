  ...
  <div class="con-page">
    <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item class="breadcrump">Официанты</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
export default {
  ...
  data: () => ({
    ...
    deleteEmpl: false,
    employee: {},
    position: {label: 'Официант', value: 'waiter'},
    waiters: JSON.parse(window.sessionStorage.waiters).employee,
    ...
    positions: [
      ...
      {
      value: 'Junior',
      label: 'Младший официант'
      },
      {
      value: 'Day',
      label: 'Дневной официант'
      },
      {
      value: 'Night',
      label: 'Ночной официант'
      },
      {
      value: 'Main',
      label: 'Главный официант'
      }
    ],
  }),
  ...
  computed: {
    searchEmployee(){
      return this.waiters.filter(post => {
  ...
  methods: {
    ...
    getWaiters() {
      this.waiters = JSON.parse(window.sessionStorage.waiters).employee
    },
    ...
    refresh() {
      this.$forceUpdate(this.getWaiters)
    }
  }
}
</script>