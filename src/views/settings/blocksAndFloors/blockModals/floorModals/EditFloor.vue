...
<!-- /////////////////////////////////////////////// -->
      ...
      <h4 style="display: none">{{setCheckedRooms.rooms.honeymoonRoom}}</h4>
...
export default {
  ...
  data:() => ({
    ...
    alreadyCheckedRooms: JSON.parse(window.sessionStorage.allBlocks).rooms,
  ...
  computed: {
    ...
    setCheckedRooms() {
      const uuu = this.alreadyCheckedRooms.find(block => block.block === this.blockID && block.floor === this.floorLevel)

      this.checkedRooms.apartment = uuu.rooms.apartment
      this.checkedRooms.bungalow = uuu.rooms.bungalow
      this.checkedRooms.deluxe = uuu.rooms.deluxe
      this.checkedRooms.honeymoonRoom = uuu.rooms.honeymoonRoom
      this.checkedRooms.duplex = uuu.rooms.duplex
      this.checkedRooms.suite = uuu.rooms.suite
      this.checkedRooms.cabana = uuu.rooms.cabana
      this.checkedRooms.juniorSuite = uuu.rooms.juniorSuite
      this.checkedRooms.residence = uuu.rooms.residence
      this.checkedRooms.familyRoom = uuu.rooms.familyRoom
      this.checkedRooms.standart = uuu.rooms.standart
      this.checkedRooms.studio = uuu.rooms.studio
      this.checkedRooms.chalet = uuu.rooms.chalet
      this.checkedRooms.economyClass = uuu.rooms.economyClass

      if(uuu.rooms.apartment !== null && uuu.rooms.apartment !== undefined && uuu.rooms.apartment !== []) {
        this.constantSortRooms.apartment.push(...uuu.rooms.apartment)
      }
      if(uuu.rooms.bungalow !== null && uuu.rooms.bungalow !== undefined && uuu.rooms.bungalow !== []) {
        this.constantSortRooms.bungalow.push(...uuu.rooms.bungalow)
      }
      if(uuu.rooms.deluxe !== null && uuu.rooms.deluxe !== undefined && uuu.rooms.deluxe !== []) {
        this.constantSortRooms.deluxe.push(...uuu.rooms.deluxe)
      }
      if(uuu.rooms.honeymoonRoom !== null && uuu.rooms.honeymoonRoom !== undefined && uuu.rooms.honeymoonRoom !== []) {
        this.constantSortRooms.honeymoonRoom.push(...uuu.rooms.honeymoonRoom)
      }
      if(uuu.rooms.duplex !== null && uuu.rooms.duplex !== undefined && uuu.rooms.duplex !== []) {
        this.constantSortRooms.duplex.push(...uuu.rooms.duplex)
      }
      if(uuu.rooms.suite !== null && uuu.rooms.suite !== undefined && uuu.rooms.suite !== []) {
        this.constantSortRooms.suite.push(...uuu.rooms.suite)
      }
      if(uuu.rooms.cabana !== null && uuu.rooms.cabana !== undefined && uuu.rooms.cabana !== []) {
        this.constantSortRooms.cabana.push(...uuu.rooms.cabana)
      }
      if(uuu.rooms.juniorSuite !== null && uuu.rooms.juniorSuite !== undefined && uuu.rooms.juniorSuite !== []) {
        this.constantSortRooms.juniorSuite.push(...uuu.rooms.juniorSuite)
      }
      if(uuu.rooms.residence !== null && uuu.rooms.residence !== undefined && uuu.rooms.residence !== []) {
        this.constantSortRooms.residence.push(...uuu.rooms.residence)
      }
      if(uuu.rooms.familyRoom !== null && uuu.rooms.familyRoom !== undefined && uuu.rooms.familyRoom !== []) {
        this.constantSortRooms.familyRoom.push(...uuu.rooms.familyRoom)
      }
      if(uuu.rooms.standart !== null && uuu.rooms.standart !== undefined && uuu.rooms.standart !== []) {
        this.constantSortRooms.standart.push(...uuu.rooms.standart)
      }
      if(uuu.rooms.studio !== null && uuu.rooms.studio !== undefined && uuu.rooms.studio !== []) {
        this.constantSortRooms.studio.push(...uuu.rooms.studio)
      }
      if(uuu.rooms.chalet !== null && uuu.rooms.chalet !== undefined && uuu.rooms.chalet !== []) {
        this.constantSortRooms.chalet.push(...uuu.rooms.chalet)
      }
      if(uuu.rooms.economyClass !== null && uuu.rooms.economyClass !== undefined && uuu.rooms.economyClass !== []) {
        this.constantSortRooms.economyClass.push(...uuu.rooms.economyClass)
      }
  ...
  methods: {
    ...
    async editFloor() {
      ...
      const floor = {
        ...
        numberFloor: Number(this.floorsLevel),
